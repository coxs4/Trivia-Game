...
public class Questions { //this is the questions class beginning
	...
	public static void setQuestions(int test) {
		if(test == 1) {
			...
			questions[1] ="1Which of the following is NOT in Boston?		#A. Fenway   #B. Gillete Stadium 		#C. TD Garden 	#D. None of the above $";
			questions[2] ="3Which President was from the Boston area?  	#A. Jimmy Carter 	#B. John F. Kennedy 		#C. Samuel Adams 	#D. Both B and C $";
			questions[3] ="2In what year was Wentworth founded?			#A. 1900		#B. 1902		#C. 1904		#D.1906 $";
